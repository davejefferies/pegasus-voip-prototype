 ...
 * Locutions
 *
 * @ORM\Table(name="Locutions", uniqueConstraints={@ORM\UniqueConstraint(name="name", columns={"name", "companyId"})}, indexes={@ORM\Index(name="companyId", columns={"companyId"})})
 * @ORM\Entity(repositoryClass="Pegasus\Gateway\Repository\LocutionsRepository")
 */
class Locutions
{
    /**
     ...
     * @var int|null
     *
     * @ORM\Column(name="originalFileFileSize", type="integer", nullable=true, options={"unsigned"=true})
     */
     ...
     * @var int|null
     *
     * @ORM\Column(name="encodedFileFileSize", type="integer", nullable=true, options={"unsigned"=true})
     */
